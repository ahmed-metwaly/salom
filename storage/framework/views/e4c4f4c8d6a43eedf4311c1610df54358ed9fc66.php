...
<?php $__env->startSection('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(URL::asset('public/web/css/bootstrap-datetimepicker.min.css')); ?>">
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>

    <?php echo $__env->make('web.home.slider', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

    <?php echo $__env->make('web.home.search', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

    <?php echo $__env->make('web.home.special_service', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

    <?php echo $__env->make('web.home.best_services', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

    <?php echo $__env->make('web.home.best_companies', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(URL::asset('public/web/js/owl.carousel.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('public/web/js/carousel-load.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('public/web/js/moment.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('public/web/js/bootstrap-datetimepicker.min.js')); ?>"></script>
    ...
    <script>
        $(document).ready(function () {
            ...
            $( "#service" ).select2({
                ...
                dir: "rtl",
                ajax: {
                    url: "<?php echo e(url('/')); ?>" + "/services/findByName",
                    dataType: 'json',
                    type: 'POST',
                    delay: 250,
            ...
            function getNearLocations(latlng) {
                ...
                $.ajax({
                    url: "<?php echo e(url('/')); ?>" + "/near-locations" ,
                    type: "POST",
