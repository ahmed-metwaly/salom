<div class="last">
    <div class="row">
        <?php $__currentLoopData = $approveOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="row color-777 p-4">
                        ...
                        <div class="col-lg-8">
                            <div class="card-block">
                                ...
                                <a class="btn btn-sm rounded-0 bg-c5 text-white btn-hover rounded mb-3 mt-md-0 mt-3" href="<?php echo e(route('web.orders.invoice', Hashids::encode($order->id))); ?>">عرض الفاتورة</a>
                            ...
                            <div class="card-footer bg-transparent border-0 px-0 pb-lg-0 pt-3 mt-md-0 mt-3">
                                ...
                                <div class='rating-stars text-center'>
                                    <ul id="stars" class='stars' service="<?php echo e($order->service->id); ?>" user-rating="<?php echo e(userServiceRating(Auth::user()->id, $order->service->id )); ?>">
