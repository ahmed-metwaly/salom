<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        <!-- BEGIN LOGO -->
        <div class="page-logo">
            <a href="<?php echo e(route('companyDashboard')); ?>">
                <img src="<?php echo e(URL::asset('public/images/logo-white.png')); ?>" alt="logo" class="logo-default" /> </a>
        ...
        <div class="top-menu">
            <ul class="nav navbar-nav pull-right">
                ...
                <!--        <li class="external">-->
                <!--            <h3>-->
                <!--                <span class="bold">3</span> إشعارات جديدة-->
                <!--            </h3>-->
                ...
                <!--                    <a href="#">-->
                <!--                        <span class="photo">-->
                <!--                            <img src="<?php echo e(URL::asset('public/company/img/avatar3.jpg')); ?>" class="img-circle" alt="">-->
                <!--                        </span>-->
                <!--                        <span class="subject">-->
                ...
                <!--                    <a href="#">-->
                <!--                        <span class="photo">-->
                <!--                            <img src="<?php echo e(URL::asset('public/company/img/avatar1.jpg')); ?>" class="img-circle" alt="">-->
                <!--                        </span>-->
                <!--                        <span class="subject">-->
                ...
                <li class="dropdown dropdown-user">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                        <img alt="" class="img-circle" src="<?php echo e(URL::asset('public/uploads/users/'. Auth::user()->photo)); ?>" />
                    ...
                    <ul class="dropdown-menu dropdown-menu-default">
                        ...
                        <li>
                            <a href="<?php echo e(route('company-logout')); ?>">
