                ...
                <div class="col-md-6 col-sm-12 mb-md-0 mb-5">
                    <div class="bg-f6 p-4 font-24 wow fadeInRight" data-wow-duration="2s">
                        ...
                        <div>
                            ...
                            <?php if(count($workDay) > 0): ?>
                                <?php $__currentLoopData = $workDay; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $work): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
