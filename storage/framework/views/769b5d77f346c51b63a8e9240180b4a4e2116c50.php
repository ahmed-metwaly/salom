<?php $__env->startSection('title'); ?>
    <?php echo e(trans('admin.servicesAdd')); ?>
...
<?php $__env->startSection('page_header'); ?>
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span><?php echo e(trans('admin.servicesAdd')); ?></span>
            </li>
        </ul>
    </div>
...
<?php $__env->startSection('content'); ?>
    <?php echo Form::open([ 'url' => route('services.store'), 'class' => 'form-horizontal', 'files' => 'true' ]); ?>
