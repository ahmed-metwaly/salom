...
<?php $__env->startSection('content'); ?>
    ...
    <div class="login">
        <div class="container">
            ...
            <?php echo Form::open([ 'url' => route('login'), 'class' => 'row bg-f6 p-5 p-5', 'files' => 'true' ]); ?>


            <div class="form-group col-sm-6 col-xs-12 mb-4 wow zoomIn <?php echo e($errors->has('email') ? ' has-error' : ''); ?>">

                <input name="email" value="<?php echo e(old('email')); ?>" type="text" class="form-control rounded-0" aria-describedby="emailHelp" placeholder="الإميل أو رقم الجوال" required="required">
            ...
            <div class="form-group col-sm-6 col-xs-12 mb-4 wow zoomIn <?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
            ...
            <div class="col mt-4 wow zoomIn">
                ...
                <a href="<?php echo e(url('/login-user-forget')); ?>" style="margin-right: 20px;"> <?php echo e(trans('admin.loginForget')); ?> </a>
            </div>
            <?php echo Form::close(); ?>
