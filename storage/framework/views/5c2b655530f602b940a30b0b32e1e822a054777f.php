        ...
        <div class="col-lg-8">
            <div class="portlet light bordered">
                <div class="portlet-body form">
                    ...
                    <?php echo Form::open( ['method' => 'PATCH', 'url' => route('works.companies.update'),'class' => 'form-horizontal']); ?>
                    ...
                    <div class="form-body">
                        ...
                        <?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div style="margin-bottom: 40px">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="md-checkbox-inline col-lg-12">
                                            <div class="md-checkbox col-md-3" style="margin-bottom: 10px;">
                                                <input id="<?php echo e($day->id); ?>" name="days[]" type="checkbox" value="<?php echo e($day->id); ?>" class="md-check" <?php echo e(checkWorkDayExists(auth::user()->id, $day->id, 'App\User') ? "checked" : " "); ?>>
                                ...
                                <?php if(checkWorkDayExists(auth::user()->id, $day->id, 'App\User')): ?>
                                    <div class="form-group mt-repeater">
                                        <div data-repeater-list="<?php echo e('old'.$day->en_day); ?>">
                                            <?php $__currentLoopData = getWorkTimes(auth::user()->id, $day->id, 'App\User'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $workTime): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
