...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-md-12">
        <form action="<?php echo e(route('center-do-edit', ['id' => $data->id])); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        <div class="collapse in" id="demo1">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="location_text" value="<?php echo e($data->location_text); ?>" class="form-control" placeholder=" <?php echo e(trans('admin.adminsADLocationText')); ?> ">
                            </div>
                            ...
                            <div class="form-group">
                                <label> ظهور بيانات العميل </label>
                                <select data-placeholder="-- <?php echo e(trans('admin.SettingsSelect')); ?> --" name="is_pro" class="select">
                                    <option value="1" <?php echo e($data->is_pro == 1 ? 'selected' : ''); ?> > <?php echo e(trans('admin.settingsOpen')); ?> </option>
                                    <option value="0" <?php echo e($data->is_pro == 0 ? 'selected' : ''); ?> > <?php echo e(trans('admin.settingsClose')); ?> </option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="checkbox" name="renew" class="">
                            </div>
