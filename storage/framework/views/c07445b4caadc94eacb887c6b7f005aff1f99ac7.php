            ...
            <div class="container">
                <div class="row py-md-4 py-0">
                    <div class="col-md-6 col-sm-12 d-flex align-items-center wow slideInRight">
                        <h2 class="h3 color-c5 font-weight-bold ">خدمات  <?php echo e($company->name); ?></h2>
                    </div>
                    <div class="col-md-6 col-sm-12 mt-0 mt-3 text-md-left text-right wow slideInLeft">
                        ...
                        <a class="h5 color-c5 font-weight-bold" href="<?php echo e(route('web.companies.show', Hashids::encode($company->id))); ?>"><?php echo e($company->name); ?> / </a>
        ...
        <div class="container">
            <div class="now">
                <div class="text-center my-5 wow fadeInDown" data-wow-duration="2s">
                    <h2 class="color-c5">خدمات  <?php echo e($company->name); ?></h2>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-xs-12 mb-5">
                        <?php if($services->hasMorePages()): ?>
                            <a href="<?php echo e($services->nextPageUrl()); ?>" class="btn btn bg-c5 font-18 py-2 px-5 text-center mx-auto text-white wow zoomIn btn-hover rounded-0" data-wow-duration="1s">مزيد من الخدمات</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
