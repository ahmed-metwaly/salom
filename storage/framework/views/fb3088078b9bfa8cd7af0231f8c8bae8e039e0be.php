...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-md-12">
        <form action="<?php echo e(route('promotions.companies.update',[$promotion->id])); ?>" method="post">
                            ...
                            <div class="collapse in" id="demo1">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="promotionCompanies" data-placeholder="-- يرجى كتابة اسم المركز --" name="promotionable_id" class="select" >
                                            ...
                                            <option value="<?php echo e($promotion->promotionable->id); ?>"><?php echo e($promotion->promotionable->name); ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" value="<?php echo e($promotion->start_at); ?>" name="start_at" required/>
                                </div>
                                <div class="form-group">
                                    <label for="promotionService">  ينتهى فى   </label>
                                    <input type="date" value="<?php echo e($promotion->end_at); ?>" class="form-control"  name="end_at" required/>
                                </div>
                            </div>    
                        </fieldset>
