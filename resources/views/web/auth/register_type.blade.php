    ...
    <div class="type">
        <div class="container text-center">
            ...
            <div class="my-5 wow fadeInDown">
                <a href="{{ route('show-register-user') }}" class="btn bg-c5 text-white rounded-0 ml-4 p-3 font-weight-bold btn-hover">
                    <i class="fa fa-user fa-2x d-block mb-2"></i>
                    <span>مستخدم</span>
                </a>
                <a href="{{ route('show-register-company') }}" class="btn bg-c5 text-white rounded-0 m-0 mr-4 p-3 font-weight-bold btn-hover">
