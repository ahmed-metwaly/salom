...
{{--@section('styles')--}}
    {{--<link rel="stylesheet" href="{{ URL::asset('public/web/css/jquery.rateyo.css') }}">--}}
{{--@endsection--}}
            ...
            <div class="container">
                <div class="row py-md-4 py-0">
                    <div class="col-md-6 col-sm-12 d-flex align-items-center wow slideInRight">
                        <h2 class="h3 color-c5 font-weight-bold ">خدمات  {{ $company->name }}</h2>
                    </div>
                    <div class="col-md-6 col-sm-12 mt-0 mt-3 text-md-left text-right wow slideInLeft">
                        ...
                        <a class="h5 color-c5 font-weight-bold" href="{{ route('web.companies.show', Hashids::encode($company->id)) }}">{{ $company->name }} / </a>
                        <span class="h5 color-c5 font-weight-bold">خدمات مركز تجميل</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="now">
                <div class="text-center my-5 wow fadeInDown" data-wow-duration="2s">
                    <h2 class="color-c5">خدمات  {{ $company->name }}</h2>
                ...
                <div class="row">
                                    ...
                                    <div class="col-lg-6 pl-lg-0 d-flex align-items-center">
                                        <div class="card-header border-0 w-100 p-0">
                                            <div class="card-img-top">
                                                <a {{ $service->is_active && !$service->has_blocked ? "href=" . route('web.services.show', Hashids::encode($service->id)) : '' }}>
                                                    <img class="w-100" src="{{ url('public/uploads/services/' . $service->photo) }}" alt="">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                           ...
                                           <div class="col-12">
                                                ...
                                                <div class="card-body border-0 p-0 pt-3">
                                                    <div class="card-block">
                                                        ...
                                                        <h4 class="card-title color-c5 font-weight-bold d-inline-block h4 mb-2 {{ strlen($service->name) > 20 ? 'pr-lg-0 pr-3 mt-3' : ''  }}">
                                                            <a class="color-c5" href="{{ route('web.services.show', Hashids::encode($service->id)) }}">
                                                                {{ $service->name}}
                                                            </a>
                                                        </h4>
                                           ...
                                           <div class="col-12">
                                               <div class="card-footer bg-transparent border-0 p-0 mb-3 row">
                                                    ...
                                                    <div class="serv-link col-8 col-sm-7 pr-0 pl-4 text-left">
                                                        <a {{ $service->is_active && !$service->has_blocked  ? "href=" . route('web.services.show', Hashids::encode($service->id)) : '' }} class="btn bg-c5 text-white btn-hover ml-2">عرض</a>
                                                        <a {{ $service->is_active && !$service->has_blocked  ? "href=" . route('web.orders.create', Hashids::encode($service->id)) : '' }} class="btn bg-c5 text-white btn-hover">حجز</a>
                                                    </div>
                                                </div>
                                           </div>
                                       </div>
                    ...
                    <div class="col-sm-12 col-xs-12 mb-5">
                        @if($services->hasMorePages())
                            <a href="{{ $services->nextPageUrl() }}" class="btn btn bg-c5 font-18 py-2 px-5 text-center mx-auto text-white wow zoomIn btn-hover rounded-0" data-wow-duration="1s">مزيد من الخدمات</a>
                        @endif
                    </div>
                </div>
            </div>
...
{{--@section('scripts')--}}
    {{--<script src="{{ URL::asset('public/web/js/jquery.rateyo.js') }}"></script>--}}
    {{--<script>--}}
        {{--$(function () {--}}
            ...
            {{--$(".rateYo").each(function (e) {--}}
                ...
                {{--stars_count = $(this).attr('data-num');--}}
