                    ...
                    <div class="row">
                        <div class="col-md-5 d-flex align-items-center">
                            <div class="serv-text p-4">
                                ...
                                <h2 class="color-c5 mb-4">{{ $service->name }}</h2>
                                <p class="text-justify color-777">
                                    {{ str_limit($service->description, 150) }}
                                </p>
                                <a href="{{ route('web.services.show', Hashids::encode($service->id)) }}" class="btn bg-c5 text-white py-2 px-4 mt-2 rounded-0 btn-hover">تفاصيل أكثر</a>
                            </div>
                        </div>
                        <div class="col-md-7 d-flex align-items-center">
                            <div class="serv-img">
                                <img class="img-fluid py-4" src="{{ url('public/uploads/services/' . $service->photo) }}" alt="{{ $service->name }}">
                            </div>
                        </div>
                    </div>
                </div>
