            ...
            <div class="container">
                <div class="row py-md-4 py-0">
                    <div class="col-md-6 col-sm-12 d-flex align-items-center wow slideInRight">
                        <h2 class="h2 color-c5 font-weight-bold ">خدمات اليوم الواحد</h2>
                    </div>
        ...
        <div class="container">
            <div class="now">
                <div class="text-center my-5 wow fadeInDown" data-wow-duration="2s">
                    <h2 class="color-c5">خدمات اليوم الواحد</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-xs-12 mb-5">
                        @if($data->hasMorePages())
                            <a href="{{ $data->nextPageUrl() }}" class="btn btn bg-c5 font-18 py-2 px-5 text-center mx-auto text-white wow zoomIn btn-hover" data-wow-duration="1s">مزيد من الخدمات</a>
                        @endif
                    </div>
                </div>
            </div>
