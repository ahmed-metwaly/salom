...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{ trans('admin.workTimesEdit') }}</span>
            </li>
        </ul>
    </div>

    <h1 class="page-title"> {{ trans('admin.workTimesIndex') }}
        <small>تعديل وقت عمل</small>
    </h1>
@endsection
        ...
        <div class="col-lg-6">
            <div class="portlet light bordered">
                <div class="portlet-body form">
                    ...
                    {!! Form::model($workTime, ['method' => 'PATCH', 'url' => route('work_times.update', $workTime->id),'class' => 'form-horizontal']) !!}
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6 input-group select2-bootstrap-append">
                                <select id="day" name="day" class="form-control select2-allow-clear">
                                    <option value="{{ $workTime->day }}" selected>{{ $workTime->day }}</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6 input-group">
                                <input name="time_from" id="time_from" type="text" class="form-control timepicker timepicker-24" value="{{ $workTime->time_from }}">
                                <span class="input-group-btn">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6 input-group">
                                <input name="time_to" id="time_to" type="text" class="form-control timepicker timepicker-24" value="{{ $workTime->time_to }}">
                                <span class="input-group-btn">
                                        <button class="btn default" type="button">
                                            <i class="fa fa-clock-o"></i>
                                        </button>
