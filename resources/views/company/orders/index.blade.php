...
{{--                                    {{ getArDay( date('D', strtotime($value->date)) ) . ' ' . date('Y-m-d', strtotime($value->date)) . ' ' .  date('g:i A', strtotime($value->date)) }}--}}
                                ...
                                <td><span class="badge badge-flat badge-roundless"> @if($value->payment->method == 'receipt') 
                                0
                                @else
                                {{ $value->payment->price }} 
                                @endif
                                    ...
                                    @if( $ordersType == 'حجوزات جديدة' )
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu">
                                                <li>
                                                    <a href="{{ route('company-orders-show', $value->id) }}">
                                                        <i class="fa fa-eye"></i> عرض التفاصيل
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="accept_order" payment_data="{{ $value->payment->id }}" order_data="{{ $value->id }}">
                                                        <i class="fa fa-check"></i> تحديد كحجز منتهي
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="reject_order" payment_data="{{ $value->payment->id }}" order_data="{{ $value->id }}">
                                                        <i class="fa fa-times"></i> تحديد كحجز لم يتم
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                    @elseif( $ordersType == 'حجوزات منتهية' )
                                        <div class="btn-group">
                                            <button class="btn btn-xs green dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false"> العمليات
                                                <i class="fa fa-angle-down"></i>
                                            </button>
                                            <ul class="dropdown-menu pull-left" role="menu">
                                                ...
                                                <li>
                                                    <a href="{{ route('company-orders-invoice', $value->id) }}">
