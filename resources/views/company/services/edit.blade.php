...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{ trans('admin.servicesEdit') }}</span>
            </li>
        </ul>
    </div>
...
@section('content')
    {!! Form::model($service, ['method' => 'PATCH', 'url' => route('services.update', $service->id),'class' => 'form-horizontal', 'files' => 'true' ]) !!}
                ...
                <div class="portlet-body form">
                    ...
                    <div class="form-body">
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    @if( $service->photo )
                                        <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 330px; height: 150px;">
                                            <img src="{{ $url = URL::to('/'). '/public/uploads/services/' . $service->photo }}">
                                        </div>
                                    @endif
                                    <div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input id="name" name="name" value="{{ $service->name }}" type="text" class="form-control" placeholder="اسم الخدمة">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input id="interval" name="interval" value="{{ $service->interval }}" type="number" class="form-control" placeholder="المدة بالدقيقة" step="5" min="5" max="500">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input id="price" name="price" type="number" value="{{ $service->price }}" class="form-control" placeholder="سعر الخدمة" step="0.50" min="0.50" max="100000">
                            </div>
                        </div>
                        ...
                        {{--<div class="form-group">--}}
                            ...
                            {{--<div class="col-lg-9">--}}
                                {{--<input id="orders_count_per_day" name="orders_count_per_day" type="number" value="{{ $service->orders_count_per_day }}" class="form-control" step="1" min="1" max="50">--}}
                            {{--</div>--}}
                        {{--</div>--}}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <textarea id="description" name="description" class="form-control autosizeme" rows="4" placeholder="وصف الخدمة ..">{{ $service->description }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input type="checkbox" {{ $service->is_home ? 'checked' : '' }} name="is_home" class="make-switch" data-on-color="success" data-off-color="danger" data-size="mini" data-on-text="نعم" data-off-text="لا">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input type="checkbox" {{ $service->one_day == 1 ? 'checked' : '' }} name="one_day" class="make-switch" data-on-color="success" data-off-color="danger" data-size="mini" data-on-text="نعم" data-off-text="لا">
                                </div>
                            </div>
