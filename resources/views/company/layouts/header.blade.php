<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        <!-- BEGIN LOGO -->
        <div class="page-logo">
            <a href="{{ route('companyDashboard') }}" style="color:#fff">
                <p>صالون</p>
            </a>
        ...
        <div class="top-menu">
            <ul class="nav navbar-nav pull-right">
                ...
                <!--                    <a href="#">-->
                <!--                        <span class="photo">-->
                <!--                            <img src="{{ URL::asset('public/company/img/avatar3.jpg') }}" class="img-circle" alt="">-->
                <!--                        </span>-->
                <!--                        <span class="subject">-->
                ...
                <!--                    <a href="#">-->
                <!--                        <span class="photo">-->
                <!--                            <img src="{{ URL::asset('public/company/img/avatar1.jpg') }}" class="img-circle" alt="">-->
                <!--                        </span>-->
                <!--                        <span class="subject">-->
                ...
                <li class="dropdown dropdown-user">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                        <img alt="" class="img-circle" src="{{ URL::asset('public/uploads/users/'. Auth::user()->photo) }}" />
