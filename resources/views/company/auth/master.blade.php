...
<!-- BEGIN HEAD -->
    ...
    <body class=" login">
        <div class="logo">
            <a href="{{ route('home') }}">
                <img src="{{ URL::asset('public/images/logo-white.png') }}" alt="" />
            </a>
        </div>
        <div class="content">
        ...
        <script src="{{ URL::asset('public/company/js/jquery.validate.min.js') }}"></script>
        <script src="{{ URL::asset('public/company/js/additional-methods.min.js') }}"></script>
        <script src="{{ URL::asset('public/company/js/login.min.js') }}"></script>
