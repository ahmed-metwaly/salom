...
@section('content')
    ...
    <div class="col-md-12">
        <form action="{{ route('center-do-edit', ['id' => $data->id]) }}" method="post" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        <div class="collapse in" id="demo1">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="location_text" value="{{ $data->location_text }}" class="form-control" placeholder=" {{ trans('admin.adminsADLocationText') }} ">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select data-placeholder="-- {{ trans('admin.SettingsSelect') }} --" name="is_pro" class="select">
                                    <option value="1" {{ $data->is_pro == 1 ? 'selected' : '' }} > {{ trans('admin.settingsOpen') }} </option>
                                    <option value="0" {{ $data->is_pro == 0 ? 'selected' : '' }} > {{ trans('admin.settingsClose') }} </option>
                                </select>
                            </div>
